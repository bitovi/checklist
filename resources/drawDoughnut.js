...
;(function($, undefined) {
  $.fn.drawDoughnutChart = function(data, options) {
    ...
    function drawPieSegments (animationDecimal) {
      ...
      drawDoughnutText(animationDecimal, segmentTotal, data);
    ...
    function drawDoughnutText(animationDecimal, segmentTotal, data) {
      $summaryNumber
        .css({opacity: animationDecimal})
        .text((segmentTotal * animationDecimal).toFixed(1));
	  var tmpNumber = settings.shortInt ? shortKInt(segmentTotal) : segmentTotal;
	  $summaryNumber.html(data[0].value+'%').css('font-size', getScaleFontSize( $summaryNumber, tmpNumber));
    }
